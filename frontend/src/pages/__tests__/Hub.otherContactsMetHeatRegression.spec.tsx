...
describe('Hub other-contacts-met heat regression', () => {
    beforeEach(() => {
    ...
    it('does not change Total / Recruitment counts when activating Other Contacts Met', async () => {
        ...
        // Click the Other Contacts Met card to switch the bottom panel
        const otherMetCard = screen.getByText(/Other Contacts Met/i)
        fireEvent.click(otherMetCard)
