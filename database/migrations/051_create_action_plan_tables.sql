-- 051_create_action_plan_tables.sql
-- Clean migration: create Action Plan tables (task, taskactionlog, tasktarget)
-- This is a duplicate of 050 but as a new, clean file name per request.
...
VALUES ('action_plan_target_type', 'Contact'),
       ('action_plan_target_type', 'Organisation'),
       ('action_plan_target_type', 'Lead') ON CONFLICT (refdataclass, refvalue) DO NOTHING;
