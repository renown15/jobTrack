...
Usage:
  source ~/dev/jobTrack/jobTrackServer/venv/bin/activate
  python tools/import_sectors_from_csv.py --csv ~/dev/jobTrack/sectordata.csv --dry-run
  python tools/import_sectors_from_csv.py --csv ~/dev/jobTrack/sectordata.csv
